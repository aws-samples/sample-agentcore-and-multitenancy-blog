...
Extends the MCP StreamableHTTPTransport to add AWS SigV4 request signing
for authentication with AgentCore Gateway using AWS_IAM authorizer.
...
async def streamablehttp_client_with_sigv4(
    ...
    Enables communication with AgentCore Gateway using AWS_IAM authorizer.
    """
